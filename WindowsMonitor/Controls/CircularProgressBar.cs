        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            try
            {
                ...
                if (this.value >= maxValue)
                {
                    ...
                    e.Graphics.DrawString(unit, new Font("华文新魏", 9F, System.Drawing.FontStyle.Bold), new SolidBrush(Color.White), new Point(this.Width / 2 + (int)size.Width / 2 - 8, this.Height / 2 - (int)size.Height + 8));
                }
                else
                {
                    ...
                    e.Graphics.DrawString(unit, new Font("华文新魏", 9F, System.Drawing.FontStyle.Bold), new SolidBrush(Color.DimGray), new Point(this.Width / 2 + (int)size.Width / 2 - 8, this.Height / 2 - (int)size.Height + 8));
                }
            }
            catch { }
        }
